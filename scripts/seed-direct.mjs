// Direct seed script — run with: node scripts/seed-direct.mjs
...
// Also clear old fake articles from previous seeds
await supabase.from("articles").delete().in("url", [
  "https://openai.com/index/introducing-o3-and-o4-mini/",
  "https://stripe.com/blog/billing-revenue-recognition",
  "https://a16z.com/ai-infrastructure-2025/",
  "https://www.figma.com/blog/how-figma-builds-product/",
  "https://review.firstround.com/the-founders-guide-to-hiring-your-first-10-engineers",
]);
...
const newArticles = [
  ...
  },
  {
    ...
    title_zh: "Mother Ventures 募得 1,000 萬美元，押注媽媽群體是新消費賽道",
...
const { data: articles, error: artErr } = await supabase
  .from("articles")
  .upsert(newArticles, { onConflict: "url" })
  .select("*");
...
const topStories = [
  {
    ...
    why_it_matters_en: "This is the clearest proof yet that AI-driven workforce reduction is happening now at major public companies. If you're building HR tech, customer support automation, or workforce analytics for SEA enterprises, this is your pitch: Cloudflare just validated the ROI. Expect enterprise buyers in Malaysia and Singapore to bring this story to every internal AI budget meeting.",
    why_it_matters_zh: "這是迄今最清晰的證明：AI 驅動的人力縮減正在主要上市公司發生。如果你正在為東南亞企業打造人力資源科技、客服自動化或勞動力分析，這就是你的推銷重點：Cloudflare 剛剛驗證了 ROI。預期馬來西亞和新加坡的企業買家會把這個故事帶到每一場內部 AI 預算會議中。",
  },
  {
  ...
  },
  {
    ...
    why_it_matters_en: "Regulatory crackdowns on AV companies create a window for SEA-focused logistics startups. While Avride is under investigation in the US, last-mile delivery automation in SEA cities remains largely unregulated. Founders building autonomous delivery for dense urban environments like KL, Jakarta, or Manila may face fewer regulatory barriers than their US counterparts — at least for now.",
    why_it_matters_zh: "對自動駕駛公司的監管打壓為專注東南亞的物流新創創造了機會視窗。當 Avride 在美國接受調查時，東南亞城市的最後一哩配送自動化仍基本不受監管。在吉隆坡、雅加達或馬尼拉等高密度城市環境打造自動配送的創業者，可能面臨比美國同行更少的監管障礙。",
  },
  {
    ...
    why_it_matters_zh: "科技公司越來越多地利用遠端分類來規避勞工義務。對於跨境招募的東南亞創業者，這是一個關於雇傭分類的警示故事。如果你使用承包商或「遠端員工」來擴張，請在衝突發生前確保你的法律結構穩固。",
  },
];

console.log("Inserting digest...");
